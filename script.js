...
if (reviewsNote) {
  ...
  reviewForm.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      const turnstileToken = reviewCompose.querySelector("[name='cf-turnstile-response']")?.value || "";
